      ...
      <main className="mx-auto flex w-full max-w-6xl flex-1 flex-col items-center gap-12 px-6 py-16">
        <div className="flex max-w-2xl flex-col items-center gap-4 text-center">
          <span className="text-xs font-semibold uppercase tracking-[0.2em] text-brand-accent">
            Rueda de Crecimiento Organizacional
          </span>
          ...
          <p className="max-w-xl text-brand-muted">
            Evalúa 8 áreas críticas de tu organización y descarga un informe con tu rueda de crecimiento,
            áreas críticas y una ruta de formación sugerida, elaborado por Academia Referente.
          </p>
        </div>
